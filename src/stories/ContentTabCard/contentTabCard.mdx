...
import * as contentTabCardStories from './contentTabCard.stories.js';

<Meta title="Components/ContentTabCard" />
...
<Story of={contentTabCardStories.Primary}>{contentTabCardStories.Primary()}</Story>
